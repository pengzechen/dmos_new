...
void init_page_table()
{
    ...
    pt1[2] = (0x80000000ULL | PTE_NORMAL_MEMORY | AP_EL0 | PXN); // 0x8000_0000 0xc000_0000         // 这个G分给el0使用
    pt1[3] = (0xc0000000ULL | PTE_NORMAL_MEMORY | AP_EL0 | PXN); // 0xc000_0000 0x1000_0000_0000    // 这个G分给el0使用
